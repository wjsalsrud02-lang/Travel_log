...
* 👤 **전민경** : 디자인과 퍼블리싱을 직접 담당하며 화면 구성과 사용자 흐름에 집중하였습니다. React로 화면을 구현하는 과정에서 컴포넌트 구조와 상태 관리의 중요성, 단순한 UI 구현을 넘어 정확성과 유지보수를 고려한 설계의 필요성을 느꼈습니다. 또한, 상태 변화에 따라 UI가 유연하게 동작하도록 구현하며 프론트엔드 개발 역량을 키울 수 있었습니다.
또한 프론트엔드와 백엔드가 분리된 구조에서 API 연동을 경험하며, 화면과 서버 간의 명확한 역할 분담이 협업 효율을 높인다는 점을 배울 수 있었습니다.
